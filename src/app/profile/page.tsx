            ...
            <div className="relative z-10">
                ...
                >
                  ...
                  {[
                    ...
                    >
                      ...
                      <motion.input
                        ...
                        onChange={handleInputChange}
                        disabled={!isEditing}
                        className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 disabled:bg-gray-50 disabled:border-gray-100 transition-all duration-200 font-medium shadow-sm"
                      />
                    </motion.div>
                  ))}
                  ...
                  >
                    ...
                    <motion.textarea
                      ...
                      disabled={!isEditing}
                      rows={4}
                      className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 disabled:bg-gray-50 disabled:border-gray-100 transition-all duration-200 font-medium shadow-sm resize-none"
              ...
              >
                <motion.h3 
                  ...
                  className="text-xl font-bold text-gray-900 border-b-2 border-amber-200 pb-3"
                >
                  Address Information
                </motion.h3>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  {[
                    { name: "address", label: "Address", span: "md:col-span-2" },
                    ...
                    >
                      ...
                      <motion.input
                        ...
                        onChange={handleInputChange}
                        disabled={!isEditing}
                        className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-amber-500 focus:border-amber-500 disabled:bg-gray-50 disabled:border-gray-100 transition-all duration-200 font-medium shadow-sm"
                      />
                    </motion.div>
                  ))}
                </div>
              ...
              >
                <div className="flex flex-wrap gap-4">
                  <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                    <Link
                      href="/account"
                      className="inline-flex items-center px-6 py-3 border-2 border-gray-300 text-gray-700 rounded-xl hover:bg-gray-50 hover:border-gray-400 transition-all duration-200 font-semibold shadow-sm"
                    >
                      ← Back to Account
                    </Link>
                  </motion.div>
                  <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                    <Link
                      href="/products"
                      className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-amber-500 to-orange-500 text-white rounded-xl hover:from-amber-600 hover:to-orange-600 transition-all duration-200 font-semibold shadow-lg hover:shadow-xl"
                    >
                      Browse Products
                    </Link>
                  </motion.div>
